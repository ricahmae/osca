...
<body>
    <div class="hero">
        ...
        <div class="detel">
            <h1>OSCA <span>ZAMBOANGA</span></h1>
            <p>This is my official Portfolio website to showcase my 
                all works related to <br> web development and ui design. </p>
            <a href="#">REGISTER NOW</a>
        </div>
        <div class="images">
        <img src="{{asset('assets/img/image7.png')}}" class="shape">
        <img src="{{asset('assets/img/oldcouple.png')}}" class="girl">
        </div>
